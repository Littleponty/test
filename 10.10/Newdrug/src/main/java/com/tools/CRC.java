...
public class CRC {
	...
	public static String main(int[] args) {
		// 0x02 05 00 03 FF 00 , crc16=7C 09    15  01  01  33 f0 00
		byte[]CRC666=new byte[args.length];		
		for(int i=0;i<args.length;i++) {
		CRC666[i]=(byte)args[i];	
		}
		int crc = CRC.calcCrc16(CRC666);
		String a;
		a=String.format("0x%04x", crc);
		System.out.println("CRC校验结果"+a);
		return a;
	}
